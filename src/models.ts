...
export const Transmitter = Type.Object({
  ...
  vp8: Type.Optional(Type.Boolean({ description: 'Transcode video to VP8' })),
  bypassVideo: Type.Optional(
    Type.Boolean({ description: 'Pass H264 video through without transcoding' })
  ),
